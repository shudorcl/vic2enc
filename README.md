...
- 🦀 核心逻辑参考 [`ParadoxLocalisationAssistant`](https://github.com/YinHu1985/ParadoxLocalisationAssistant)（C#/WinForms）在 Rust 中按**字节级**重写，保证无损往返。
...
把mod（中文硬编码在 localisation CSV 与 events/decisions/common 脚本里）迁移到现代 **`assets/localisation/zh-CN`**「PA 汉化」式（UTF-8）布局：
...
- 编码往返核心逻辑参考自 [`ParadoxLocalisationAssistant`](https://github.com/YinHu1985/ParadoxLocalisationAssistant)（C#/WinForms）。
